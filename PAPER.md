...
**Global expansion (April 29).** Visa announced the **global expansion of its Agentic Ready program to Asia Pacific and Latin America**, extending beyond the initial European launch. In **Australia**, banks and fintechs were added to the testing framework. **Singapore** became the first Southeast Asian market to join the program. Visa framed the expansion as critical preparation for the "next era of agentic commerce," noting the shift from viewing AI agents as security threats to recognizing them as legitimate economic actors. The expansion brings Agentic Ready to three continents with live testing partners [[85]](#ref85) [[86]](#ref86).
...
| **Google** | UCP + A2A + AP2 + Business Agent | Open standards; buy button in Search/Gemini; Cart, Catalog, Identity Linking (March 2026); A2A for agent coordination; PayPal UCP integration; AP2 consortium (60+ companies, Revolut Pay A2A integration); **Business Agent** (branded AI sales agents on Search — Lowe's, Michaels, Poshmark, Reebok) | Ads/shopping commissions (likely) | GA (Jan 2026; expanded March 2026) | Product discovery, multi-item checkout, post-purchase, agent-to-agent, account-to-account payments, merchant-branded search agents | Open |
...
| **Visa** | Trusted Agent Protocol + Agentic Ready + AI Dispute Suite | Cryptographic agent verification; card-network settlement; Agentic Ready testing (21 EU bank partners); **global expansion to APAC + LatAm** (April 2026 — Australia, Singapore); **AI Dispute Resolution Suite** (6 tools, 106M disputes/yr); **Ramp agentic corporate bill pay** (50K+ clients) | Network interchange fees | GA (Agentic Ready March 2026; global expansion April 2026; Dispute Suite April 2026) | Agent identity verification, fraud prevention, bank testing, corporate bill pay, dispute resolution | Consortium |
...
Six or more major protocols (MPP, ACP, UCP, x402, ATXP, APP) are live simultaneously, with aggregation layers like Alchemy's AgentPay emerging to abstract the fragmentation. Will the market converge on one standard, or will a multi-protocol world persist? UCP's explicit compatibility with A2A, ACP, and MCP suggests a layered rather than winner-take-all outcome, while ATXP's and OKX APP's entries signal continued startup innovation in the payment layer. The emergence of protocol aggregators suggests the market may settle on a multi-protocol reality with middleware abstraction rather than a single winner. Convergence is far from certain.
